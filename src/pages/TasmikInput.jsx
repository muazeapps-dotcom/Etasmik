          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4">
            ...
            <div className="bg-white p-6 rounded-[2.5rem] shadow-xl border border-gray-100">
              ...
              <div className="max-h-60 overflow-y-auto space-y-2 pr-2 custom-scrollbar">
                {loading ? (
                  ...
                  <p className="text-center text-gray-400 text-xs font-bold py-4">Tiada data murid. Sila masukkan di Supabase.</p>
                )}
              </div>
            </div>
            ...
            {studentName && (
              <form onSubmit={handleSubmit} className="bg-white p-6 rounded-[2.5rem] shadow-xl border border-gray-50 space-y-5">
                 ...
                 <div>
                    <span className="text-[10px] font-black text-gray-400 uppercase ml-2 mb-1 block tracking-tighter">Nombor Halaman</span>
                    <input 
                      type="number"
